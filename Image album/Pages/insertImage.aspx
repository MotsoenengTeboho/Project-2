...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Title is required." ControlToValidate="titleTxt" CssClass="parameters"></asp:RequiredFieldValidator>
