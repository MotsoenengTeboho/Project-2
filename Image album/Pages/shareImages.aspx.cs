...
namespace Image_album.Pages
{
    ...
    {
        SqlConnection con = new SqlConnection(@"workstation id=imageAlbumDb.mssql.somee.com;packet size=4096;user id=motsoenengT_SQLLogin_3;pwd=etx2iu8p79;data source=imageAlbumDb.mssql.somee.com;persist security info=False;initial catalog=imageAlbumDb");
        ...
        protected void btnViewAlbum_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string selectQuery = "SELECT * FROM [Album] WHERE Album_Name = '" + DropDownList1.SelectedItem + "' AND User_Email = '"+ Session["email"] +"'";
